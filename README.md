...
![UnityHub](ImagesDoc/UnityHub.png)
...
![UnityHubInstall](ImagesDoc/UnityHubInstall.jpeg)

5. Go to `Preferences` and make sure you have [activated your license](https://support.unity.com/hc/en-us/articles/211438683-How-do-I-activate-my-license) to be able to install the correct version of the `Unity Editor` and correctly load the **UNetyEmu** project;

![UnityHubPreferences](ImagesDoc/UnityHubPreferences.png)

6. Now, go to `Installs -> Install Editor -> Archive` and click  on the link `download archive`, this will open a website with all versions of the Unity Editor available for [download](https://unity.com/releases/editor/archive);

![Install](ImagesDoc/Install.png)

7. Search for version `2022.3.22f1` and select the `Install` button on the website, this will redirect to `Unity Hub`;

![InstallVersion](ImagesDoc/InstallVersion.png)

8. `Continue` with the installation of the `Unity Editor` and wait for it to finish. Now, you are ready to load the **UNetyEmu** project in `Unity Hub` using the `Unity Editor` just installed. If you had any problems with the installation of the `Unity Editor`, follow the [Unity installation manual](https://unity.com/releases/editor/whats-new/2022.3.22).

![ContinueInstallation](ImagesDoc/ContinueInstallation.jpeg)

![WaitInstallation](ImagesDoc/WaitInstallation.jpeg)
...
![BaseStation](ImagesDoc/BaseStation.png)
...
![Firewall1](ImagesDoc/Firewall1.png)

16. Change the `Firewall state` to `Off`, then select `Apply` and then `Ok`;

![Firewall2](ImagesDoc/Firewall2.png)
...
![Rules1](ImagesDoc/Rules1.png)

16. Select `Inbound Rules`, and then `New rule`

![Firewall3](ImagesDoc/Firewall3.png)

17. Rule Type as `Port`;

![Port](ImagesDoc/Port.png)
    
18. For simplicity, make all ports available;

![tcp](ImagesDoc/tcp.png)
...
![Scenario1](ImagesDoc/Scenario1.png)
...
![Scenario2](ImagesDoc/Scenario2.png)
...
![Scenario3](ImagesDoc/Scenario3.png)
...
![unetyemu3](ImagesDoc/unetyemu3.png)
